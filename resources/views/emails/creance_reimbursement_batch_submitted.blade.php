...
<html lang="fr">
  <head>
    ...
    <title>Remboursement global soumis</title>
  </head>
  <body style="font-family: Arial, sans-serif; line-height: 1.45;">
    <h2>Remboursement global soumis</h2>

    <p>Un client vient de soumettre un remboursement global (en attente de validation).</p>
    ...
    <ul>
      ...
      <li><strong>Montant total soumis :</strong> {{ $totalSubmitted }}</li>
      <li><strong>Pièce jointe :</strong> {{ !empty($hasProof) ? 'Oui' : 'Non' }}</li>
    </ul>
