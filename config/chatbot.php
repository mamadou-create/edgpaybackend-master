...
return [
    ...
    'intent_keywords' => [
        ...
        'announcements_feed' => ['annonces', 'voir les annonces', 'annonces classiques', 'consulter les annonces', 'mes annonces'],
        'create_announcement' => ['publier annonce', 'publier une annonce', 'creer une annonce', 'creer annonce', 'créer une annonce'],
        'occasion_market' => ['marche occasion', 'marché occasion', 'voir les occasions', 'occasions', 'encheres', 'enchères'],
        'occasion_publish' => ['publier occasion', 'publier une occasion', 'vendre un article d occasion', 'mettre un article en vente'],
    ...
    'app_knowledge' => [
        ...
        'announcement_feed_help' => [
            'patterns' => ['comment voir les annonces', 'ou voir les annonces', 'comment consulter les annonces', 'annonces classiques'],
            'reply' => 'Je peux ouvrir le flux Annonces pour parcourir les publications classiques disponibles dans EdgPay.',
            'buttons' => ['Annonces', 'Publier annonce'],
            'knowledge_topic' => 'announcements',
            'action' => 'open_announcements_feed',
        ],
        'announcement_publish_help' => [
            'patterns' => ['comment publier une annonce', 'comment creer une annonce', 'je veux publier une annonce', 'mettre une annonce'],
            'reply' => 'Je peux ouvrir le formulaire de publication d\'annonce classique. Cette action est disponible pour les comptes client et super admin.',
            'buttons' => ['Publier annonce', 'Annonces'],
            'knowledge_topic' => 'announcements',
            'action' => 'open_announcement_publish_flow',
        ],
        'occasion_market_help' => [
            'patterns' => ['comment voir le marche occasion', 'ou voir les occasions', 'comment consulter les enchères', 'marche occasion'],
            'reply' => 'Je peux ouvrir le Marché occasion & enchères pour parcourir les articles disponibles et les ventes aux enchères.',
            'buttons' => ['Marché occasion', 'Publier occasion'],
            'knowledge_topic' => 'occasion',
            'action' => 'open_occasion_market_flow',
        ],
        'occasion_publish_help' => [
            'patterns' => ['comment publier une occasion', 'comment vendre un article d occasion', 'mettre un article en vente', 'publier occasion'],
            'reply' => 'Je peux ouvrir la publication d\'occasion pour ajouter un article à vendre ou à mettre aux enchères. Cette action est réservée aux comptes client.',
            'buttons' => ['Publier occasion', 'Marché occasion'],
            'knowledge_topic' => 'occasion',
