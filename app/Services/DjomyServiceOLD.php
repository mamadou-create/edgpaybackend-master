...
// class DjomyServiceOLD implements DjomyServiceInterface
// {
//     public ?User $user;
...
//             // Si le token a expiré (erreur 401), se ré-authentifier et réessayer
...
//                 return $this->makeRequest($method, $endpoint, $data, $withAuth);
//             }
...
//     /**
//      * 🎯 Récupérer les headers pour les requêtes
//      */
