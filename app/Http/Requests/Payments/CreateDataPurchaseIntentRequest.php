...
class CreateDataPurchaseIntentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_plan_id' => ['required', 'string', 'max:60'],
            'data_plan_name' => ['sometimes', 'string', 'max:255'],
            'validity' => ['sometimes', 'string', 'max:255'],
            'allowance' => ['sometimes', 'string', 'max:255'],
